...
const Detail = () =>{
  ...
  console.log(route.params)//point_id
  //console.log(routeParams.location.lat)//point_id
  
  function handleNavigateBack(){
    navigation.goBack();
  }

//Implementacao de direcao de rotas no google
/*   function handleComposeHowToGet() { 
    Linking.openURL(`https://www.google.com.br/maps/dir/${routeParams.location.lat},
    ${routeParams.location.long}/${data.point.latitude},${data.point.longitude}`)
  }
 */
  ...
  function handleComposeMail(){
    MailComposer.composeAsync({
      subject:'Interesse em cadastrar na coleta de residuos',
